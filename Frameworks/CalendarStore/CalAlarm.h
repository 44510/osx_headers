...
+ (id)alarm;
@property(copy) NSDate *absoluteTrigger; // @synthesize absoluteTrigger=_absoluteTrigger;
@property double relativeTrigger; // @synthesize relativeTrigger=_relativeTrigger;
