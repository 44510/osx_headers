...
@class ACAccountStore, NSFileHandle, NSSet, NSString, NSURL;
...
@property(nonatomic) BOOL supportsCustomSignInUI; // @synthesize supportsCustomSignInUI=_supportsCustomSignInUI;
@property(retain, nonatomic) NSString *humanFriendlyName; // @synthesize humanFriendlyName=_humanFriendlyName;
@property(retain, nonatomic) NSFileHandle *osxLogo; // @synthesize osxLogo=_osxLogo;
@property(retain, nonatomic) NSFileHandle *osxIcon; // @synthesize osxIcon=_osxIcon;
