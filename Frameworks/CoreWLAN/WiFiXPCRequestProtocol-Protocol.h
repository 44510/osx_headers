...
- (void)queryGASCacheWithANQPElements:(unsigned long long)arg1 bssid:(NSString *)arg2 hessid:(NSString *)arg3 maxAge:(double)arg4 reply:(void (^)(NSError *, NSSet *))arg5;
- (void)performGASQueryWithANQPElements:(unsigned long long)arg1 bssid:(NSString *)arg2 hessid:(NSString *)arg3 channel:(CWChannel *)arg4 maxAge:(double)arg5 interfaceName:(NSString *)arg6 waitForWiFi:(BOOL)arg7 waitForBluetooth:(BOOL)arg8 token:(long long)arg9 priority:(long long)arg10 reply:(void (^)(NSError *, NSSet *))arg11;
- (void)clearGASCacheForBSSID:(NSString *)arg1 hessid:(NSString *)arg2 reply:(void (^)(NSError *))arg3;
- (void)clearGASCacheWithReply:(void (^)(NSError *))arg1;
