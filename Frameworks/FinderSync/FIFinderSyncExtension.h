...
@interface FIFinderSyncExtension : NSObject <FIFinderSyncExtensionProtocol>
{
    id <FIFinderSync> _delegate;
}

@property id <FIFinderSync> delegate; // @synthesize delegate=_delegate;
...
- (void)instantiateExtensionClass;
- (void)begin;
- (id)init;
