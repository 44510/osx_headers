...
@class AMDescriptionViewController, AMGlossyStatusView, AMGradientBackgroundView, AMLibraryOutlineView, AMLibraryTableView, AMSmartGroupsController, AMSplitView, AMSplitViewDividerHandle, NSArray, NSArrayController, NSButton, NSMenu, NSPopUpButton, NSSearchField, NSString, NSTabView, NSTreeController, NSView;
...
@interface AMLibraryViewController : NSViewController <NSSplitViewDelegate>
{
    ...
    AMSplitViewDividerHandle *_dividerHandle;
...
@property(readonly) AMSplitViewDividerHandle *dividerHandle; // @synthesize dividerHandle=_dividerHandle;
