...
@class CALayer, NCRemotePlugIn, NSArray, NSDate, NSLayoutConstraint, NSMutableArray, NSObject<OS_dispatch_source>, NSString, _NCRemoteView, _NCRemoteViewBackground;
