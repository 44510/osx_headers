...
@class GEOAddress, GEOFeatureStyleAttributes, GEOMapRegion, GEOPDFlyover, GEOPlace, MKMapItemMetadata, MKPlacemark, NSArray, NSData, NSString, NSURL, _MKMapItemPhotosAttribution, _MKMapItemPlaceAttribution, _MKMapItemReviewsAttribution;
