...
+ (id)shortDayMonthChineseHanidayFormatter;
+ (id)shortDayMonthYearChineseHanidayFormatter;
+ (id)longDayMonthYearChineseHanidayFormatter;
...
+ (id)formatterFuturesWithLocale:(id)arg1 includeHanidayFormatters:(BOOL)arg2;
...
- (BOOL)shouldUseHanidayFormatters;
