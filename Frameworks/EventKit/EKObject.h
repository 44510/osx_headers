...
@class EKChangeSet, EKEventStore, EKFrozenObject, NSDictionary, NSManagedObjectID, NSMutableDictionary, NSString;
...
@property(retain, nonatomic) NSDictionary *batchChangeInfo; // @synthesize batchChangeInfo=_batchChangeInfo;
...
- (void)applyUnbatchedChangesFromObject:(id)arg1;
