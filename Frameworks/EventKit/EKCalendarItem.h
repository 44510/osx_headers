...
@property(retain, nonatomic) NSDate *cachedStartDate; // @synthesize cachedStartDate=_cachedStartDate;
...
- (id)_dictionaryForDuplicatingItemWithoutAttendees;
