...
@class AVPlayerControllerTimeResolver, AVSlowMotionSlider, NSString, NSView;

@interface AVTrimControlsViewController : AVPlayerControlsViewController <AVSlowMotionSliderDelegate, AVTrimViewDelegate>
{
