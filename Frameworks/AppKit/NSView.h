...
@interface NSView : NSResponder <NSOpenGLDefaultFramebufferLayerDelegate, NSAnimatablePropertyContainer, NSUserInterfaceItemIdentification, NSDraggingDestination, NSAppearanceCustomization, NSAccessibilityElement, NSAccessibility>
{
...
- (void)drawOpenGLDefaultFramebufferLayer:(id)arg1 inCGLContext:(struct _CGLContextObject *)arg2;
