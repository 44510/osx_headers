...
@class NSCGSWindowCALayerAdaptor, NSColor, NSColorSpace, NSData, NSDictionary, NSDockTile, NSError, NSGraphicsContext, NSInspectorBar, NSMapTable, NSMutableArray, NSMutableSet, NSRecursiveLock, NSRegion, NSResponder, NSScreen, NSString, NSToolbar, NSUndoManager, NSView, NSViewController, NSViewHierarchyLock, NSWindow, NSWindowController, _NSWindowAnimator, _NSWindowTransformAnimation;
