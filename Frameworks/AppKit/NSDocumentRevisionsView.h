...
@class CALayer, NSArray, NSDocumentRevisionsButtonGroup, NSDocumentRevisionsController, NSDocumentRevisionsLabel, NSDocumentRevisionsPlaceholderView, NSDocumentRevisionsProgressIndicator, NSMapTable, NSMutableArray, NSWindow;
...
- (void)ensureSnapshotForStackItemAtIndex:(unsigned long long)arg1 forceNew:(BOOL)arg2 wait:(BOOL)arg3;
