...
@class NSButton, NSImage, NSLayoutConstraint, NSNumber, NSPopUpButton, NSProgressIndicator, NSString, NSTextField, NSTextView, NSView, SLXShareImageView, SLXShareLocationController, SLXShareWindowBackgroundView;
