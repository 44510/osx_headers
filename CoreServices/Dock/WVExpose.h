...
#import "ECCoverFlowActionHandling.h"
#import "ECCoverFlowDataSource.h"
...
@class CALayer, ECCoverFlow, NSArray, NSMutableArray, NSMutableDictionary, NSMutableSet, NSMutableString, NSObject<OS_dispatch_source>, NSString, Tile, WAWindow, WVDisplay, WVDragWindow, WVHotCorners, WVNewExposeWindowsLayer, _CGSSpace, _WVGestureInfo;

@interface WVExpose : NSObject <ECModalEventHandler, WVNewExposeActionHandling, ECCoverFlowDataSource, ECCoverFlowActionHandling, WVRecentsDataSourceClient, ECEventHandlingDelegate, WVSpacesStripActionHandling, DOCKGestureHandler>
{
