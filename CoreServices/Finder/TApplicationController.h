...
@class NSMenu, NSMenuItem, NSString, TArrangeByMenuController, TICloudAccountManager, TMidnightTimer;
...
- (void)loadMenuBar;
- (void)cmdOpenAddressBookWithFinderKit:(id)arg1;
- (void)cmdOpenTextEditWithFinderKit:(id)arg1;
- (void)debugFrameworksByLaunchingExecutable:(const struct TString *)arg1;
- (void)cmdOpenSimpleFinderWindow:(id)arg1;
- (void)cmdAuthenticateForRaft:(id)arg1;
- (void)cmdRunBuildbotRaftTest:(id)arg1;
...
- (void)animateToFullScreenFromDebugMenu:(id)arg1;
...
- (void)dealloc;
- (void)someWindowBecameMain:(id)arg1;
- (id)init;
- (void)dailyLogging:(id)arg1;
