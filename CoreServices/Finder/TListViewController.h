...
@interface TListViewController : TBrowserViewController <NSOutlineViewDelegate, NSTableViewDelegate, NSOutlineViewDataSource, NSWindowDelegate, NSMenuDelegate, AccessibilityProtocol, TNameTextFieldDelegate, NSScrollViewDelegate>
{
...
- (id)appCentricLibraryFolderIcon:(const struct TFENode *)arg1 includeAppIconOverlay:(_Bool)arg2;
