...
{
    struct vector<long, std::__1::allocator<long>> _animationPendingForEdges;
...
+ (void)getTabRectsForTabCount:(long long)arg1 forBounds:(struct CGRect)arg2 proposedRects:(vector_b8c73e0a *)arg3;
