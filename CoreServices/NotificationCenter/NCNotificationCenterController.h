...
@class NCDNDController, NCMenuConnection, NCNotificationCenter, NCNotificationCenterWindowAnimator, NCNotificationCenterWindowController, NCWindowLayoutController, NSMenu, NSMutableArray, NSObject<OS_dispatch_source>, NSStatusItem, NSString;
