...
#import "NCAppInfoDelegate.h"
#import "NCNotificationTableDataSource.h"

@class NSArray, NSMutableArray, NSMutableDictionary, NSMutableSet, NSObject<OS_dispatch_queue>, NSObject<OS_xpc_object>, NSString, NSUserNotification;
