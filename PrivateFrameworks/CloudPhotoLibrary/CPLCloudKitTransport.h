...
- (void)downloadResource:(id)arg1 clientBundleID:(id)arg2 foreground:(BOOL)arg3 cancelState:(id)arg4 didStartHandler:(CDUnknownBlockType)arg5 progressHandler:(CDUnknownBlockType)arg6 completionHandler:(CDUnknownBlockType)arg7;
- (void)_updateDownloadOperation:(id)arg1 withCellularAccessForResource:(id)arg2 isForeground:(BOOL)arg3;
...
- (void)createPrimaryZoneWithCompletionHandler:(CDUnknownBlockType)arg1;
