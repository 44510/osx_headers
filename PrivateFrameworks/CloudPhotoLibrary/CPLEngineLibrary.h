...
@class CPLConfiguration, CPLEngineScheduler, CPLEngineStore, CPLEngineSyncManager, CPLEngineSystemMonitor, CPLEngineTransport, CPLPlatformObject, CPLStatistics, NSArray, NSError, NSHashTable, NSObject<OS_dispatch_queue>, NSString, NSURL;
