...
+ (id)_datesByExpandingLunarBirthdayFromDate:(id)arg1 toDate:(id)arg2 duration:(double)arg3 recurrenceStartDate:(id)arg4 isAllDay:(BOOL)arg5 lunarCalendarString:(id)arg6;
