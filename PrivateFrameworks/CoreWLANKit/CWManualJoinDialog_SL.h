...
@class CWInterface, CWNetwork, CWNetworkProfile, NSArray, NSButton, NSPopUpButton, NSProgressIndicator, NSScrollView, NSSecureTextField, NSString, NSTableView, NSTextField, NSView, SFCertificateView;
