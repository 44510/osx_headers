...
- (void)iCloudRecoverManageFDEUsersForDisk:(id)arg1 withPCSIdentity:(struct _PCSIdentityData *)arg2 addingUsers:(id)arg3 removingUsers:(id)arg4 handlingProgress:(CDUnknownBlockType)arg5 withCompletionBlock:(CDUnknownBlockType)arg6;
- (void)manageFDEUsersForDisk:(id)arg1 diskUnlockPassword:(id)arg2 addingUsers:(id)arg3 removingUsers:(id)arg4 handlingProgress:(CDUnknownBlockType)arg5 withCompletionBlock:(CDUnknownBlockType)arg6;
