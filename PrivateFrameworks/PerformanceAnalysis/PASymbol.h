...
@class NSMutableArray, NSString, PASymbolOwner;
...
@property(readonly) PASymbolOwner *owner; // @synthesize owner=_owner;
...
- (id)initEmptySymbolWithOwner:(id)arg1 andOffsetIntoOwner:(unsigned long long)arg2;
- (void)dealloc;
- (void)addSourceInfo:(id)arg1;
- (BOOL)hasAnySourceInfo;
- (id)sourceInfoWithOffsetIntoSymbol:(unsigned long long)arg1;
- (id)initWithCSSymbolRef:(struct _CSTypeRef)arg1 andSymbolOwner:(id)arg2;
