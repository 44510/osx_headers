...
@class NSArray, NSMutableArray, NSSet, NSString, NSUUID, PASampleTaskDataPrivateData, PASampleTimeInsensitiveTaskData;

@interface PASampleTaskData : NSObject <PASerializable>
{
    NSMutableArray *sampleThreadsArray;
...
- (void)dealloc;
- (void)addNewSampleThreadDataForStackshotThread:(id)arg1 withLeafFrame:(id)arg2;
