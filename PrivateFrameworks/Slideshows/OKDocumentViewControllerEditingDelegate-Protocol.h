...
@class NSDictionary, OKDocumentViewController, OKDocumentWidget;
...
- (BOOL)documentViewController:(OKDocumentViewController *)arg1 shouldChangeTextForWidget:(OKDocumentWidget *)arg2 toSettings:(NSDictionary *)arg3;
