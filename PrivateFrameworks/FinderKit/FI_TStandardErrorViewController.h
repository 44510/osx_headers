...
@class FI_TButton, FI_TTextField, NSImage, NSString;
...
@interface FI_TStandardErrorViewController : FI_TViewController
{
    ...
    FI_TTextField *_messageText;
    struct TString _messageString;
    FI_TButton *_leftButton;
    struct TString _leftButtonTitle;
    _Bool _leftButtonIsHiddenHint;
    struct TNSRef<FI_TTargetActionFunctor *> _leftButtonFunctorAdapter;
    FI_TButton *_middleButton;
    struct TString _middleButtonTitle;
    _Bool _middleButtonIsHiddenHint;
    struct TNSRef<FI_TTargetActionFunctor *> _middleButtonFunctorAdapter;
    FI_TButton *_rightButton;
    struct TString _rightButtonTitle;
    _Bool _rightButtonIsHiddenHint;
    struct TNSRef<FI_TTargetActionFunctor *> _rightButtonFunctorAdapter;
    FI_TButton *_applyAllCheckbox;
