...
+ (id)sharedInstance;
@property(readonly) NSArray *contacts; // @synthesize contacts=_contacts;
- (void).cxx_destruct;
...
@property(readonly) CDUnknownBlockType contactsNameComparator;
@property(readonly) BOOL firstLastSorting;
