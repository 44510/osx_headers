...
@property(retain) NSView *leaveButtonSeparatorView; // @synthesize leaveButtonSeparatorView=_leaveButtonSeparatorView;
...
@property(retain) NSView *muteSeparatorView; // @synthesize muteSeparatorView=_muteSeparatorView;
...
@property(retain) NSView *addRecipientSeparatorView; // @synthesize addRecipientSeparatorView=_addRecipientSeparatorView;
