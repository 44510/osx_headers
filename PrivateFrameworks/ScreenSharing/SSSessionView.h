...
- (void)showConnectionDroppedWarning;
- (void)showAppleIDSessionWasClosedWarning;
...
- (BOOL)loadCredentialsFromKeychain:(id)arg1;
- (int)removeCredentialsFromKeychainWithAddress:(id)arg1 accountName:(id)arg2;
- (struct OpaqueSecKeychainItemRef *)findCredentialInKeychainForAddress:(id)arg1 inRequestedAccountName:(id)arg2 outAccountName:(id *)arg3;
...
- (id)orderedArrayOfAuthTypesForMethod:(long long)arg1 preferKerberos:(BOOL)arg2;
