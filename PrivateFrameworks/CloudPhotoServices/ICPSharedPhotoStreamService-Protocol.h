...
- (void)unsubscribeFromSharedPhotoStreamWithIdentifier:(NSString *)arg1 reply:(void (^)(NSDictionary *, NSError *))arg2;
...
- (void)sharedPhotoStreamsForIdentifiers:(NSArray *)arg1 options:(NSDictionary *)arg2 reply:(void (^)(NSDictionary *, NSError *))arg3;
- (void)sharedPhotoStreamsWithOptions:(NSDictionary *)arg1 reply:(void (^)(NSArray *, NSError *))arg2;
