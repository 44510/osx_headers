...
@interface DeltaHierarchy : NSObject
{
    ...
    long long _estimateChangeNotificationBytesLast;
    double _estimateChangeNotificationTimeDelta;
    double _estimateChangeNotificationTimeLast;
    id _delegate;
}
...
- (void)scheduleSizeChangeNotification:(id)arg1;
- (void)handleSizeChangeNotification:(id)arg1;
- (BOOL)haveCurrentSnapshot;
- (BOOL)faultUpwardPathForObject:(id)arg1 forSnapshot:(id)arg2 matchOwnership:(BOOL)arg3 fixUpwardMarkers:(BOOL)arg4 foundPhotoFSReservation:(char *)arg5;
