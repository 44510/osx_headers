...
@class FlippedView, NSMutableArray, NSString, VisualTabPickerViewController;
...
- (struct CGRect)visualTabPickerTileContainerView:(id)arg1 originalFrameForTileAtIndex:(unsigned long long)arg2;
