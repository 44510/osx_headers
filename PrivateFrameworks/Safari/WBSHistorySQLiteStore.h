...
@class NSArray, NSCountedSet, NSData, NSMapTable, NSMutableDictionary, NSMutableSet, NSObject<OS_dispatch_queue>, NSString, NSTimer, NSURL, WBSSQLiteDatabase;
...
- (void)_removeVisitsProvidedByBlockInvokedOnDatabaseQueue:(CDUnknownBlockType)arg1 addingTombstone:(id)arg2;
...
- (void)_openDatabase:(id)arg1 migrateFromPropertyListIfNeeded:(BOOL)arg2;
...
- (void)_clearHistoryVisitsMatchingURLString:(id)arg1 afterDate:(id)arg2 beforeDate:(id)arg3 addingTombstone:(id)arg4;
- (void)_clearHistoryVisitsAddedAfterDate:(id)arg1 beforeDate:(id)arg2 addingTombstone:(id)arg3;
- (void)clearHistory;
- (void)removePastHistoryVisitsForItem:(id)arg1;
