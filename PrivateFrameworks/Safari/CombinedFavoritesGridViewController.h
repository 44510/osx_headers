...
@class GridView, NSArray, NSLayoutConstraint, NSMapTable, NSScrollView, NSString, NSView, StartPageViewController, TestDriveMigrationBannerViewController, WebBookmarkList;
...
- (void)_updateStartPageBackButton;
