...
@class CombinedFavoritesGridViewController, KeyLoopSplicingContainerView, NSArray, NSButton, NSLayoutConstraint, NSSegmentedControl, NSString, NSView, NSViewController<StartPageContentViewController>, TestDriveMigrationBannerViewController, TopSitesViewController;
