...
@class Animation, CompletionWindow, NSLayoutConstraint, NSMutableArray, NSString, NSView, NSWindow;
...
@interface CompletionUIPresentationController : NSObject <NSAnimationDelegate>
{
    ...
    Animation *_presentationAnimation;
...
- (void)_updateCompletionWindowAppearanceForAnimationProgress:(float)arg1;
...
@property(readonly, nonatomic) CDStruct_3c058996 contentInset;
