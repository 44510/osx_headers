...
@class BrowserToolbarItem, BrowserWindowControllerMac, ButtonPlus, NSSegmentedControl, NSString, NSToolbarItem, NSView, NSWindow, OneStepBookmarkingButton, ReaderButton, ToolbarDownloadsButton, TopSitesButton, UnifiedField;
