...
@class CKDClientContext, CKDProtobufStreamWriter, CKDProtocolTranslator, NSArray, NSData, NSDate, NSDictionary, NSError, NSFileHandle, NSHTTPURLResponse, NSInputStream, NSMutableArray, NSMutableDictionary, NSOperationQueue, NSRunLoop, NSString, NSURL, NSURLRequest, NSURLSessionConfiguration, NSURLSessionDataTask;
...
@property(retain, nonatomic) NSString *_testUnderscoreProperty; // @synthesize _testUnderscoreProperty=__testUnderscoreProperty;
