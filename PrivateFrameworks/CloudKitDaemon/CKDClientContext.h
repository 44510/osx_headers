...
@class CKAccountInfo, CKContainerID, CKDAccount, CKDFlowControlManager, CKDMMCS, CKDPCSManager, CKDServerConfiguration, NSArray, NSBundle, NSMutableDictionary, NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_semaphore>, NSString, NSURL;
...
@property(nonatomic) BOOL canAccessAccounts; // @synthesize canAccessAccounts=_canAccessAccounts;
...
@property(readonly, nonatomic) NSString *applicationPackageCacheDirectory;
