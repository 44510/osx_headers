...
- (void).cxx_destruct;
- (id)_serverNameForMailbox:(id)arg1 parentServerName:(id)arg2 separatorCharacter:(id)arg3;
- (id)_separatorCharacterWithGateway:(id)arg1;
- (BOOL)deleteMailboxFromServer:(id)arg1;
- (BOOL)renameMailbox:(id)arg1 newName:(id)arg2 newParentServerName:(id)arg3;
- (BOOL)addMailboxToServer:(id)arg1 parentServerName:(id)arg2;
...
- (id)_addSubmailboxes:(id)arg1 toParent:(id)arg2 localMailboxes:(id)arg3;
