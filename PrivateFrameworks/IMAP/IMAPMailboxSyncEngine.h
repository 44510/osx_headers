...
@class IMAPGateway, IMAPMailbox, MCInvocationQueue, NSArray, NSMutableArray, NSMutableIndexSet, NSMutableSet, NSString;
...
@property BOOL shouldLogIMAPMailboxSyncEngineActivity; // @synthesize shouldLogIMAPMailboxSyncEngineActivity=_shouldLogIMAPMailboxSyncEngineActivity;
