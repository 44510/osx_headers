...
@class MCError, MFCriterion, MFMailAccount, NSArray, NSMutableIndexSet, NSMutableSet, NSOperationQueue, NSString;
...
@interface MFMailbox : NSObject <MCGmailLabel, MCMailbox, MFUIMailbox>
{
    ...
    id _userInfoQueueLock;
    NSOperationQueue *_userInfoQueue;
