...
+ (BOOL)_hasCacheFileForMessageWithLibraryID:(long long)arg1 mailboxID:(long long)arg2 directoryContents:(id)arg3;
...
+ (void)_sendAttributesToSpotlightForMessage:(id)arg1 path:(id)arg2;
...
+ (BOOL)setupLibrary;
+ (void)setLogLibraryErrors:(BOOL)arg1;
+ (BOOL)logLibraryErrors;
+ (void)setLogSqliteQueries:(BOOL)arg1;
+ (BOOL)logSqliteQueries;
+ (void)setLogSqliteErrors:(BOOL)arg1;
+ (BOOL)logSqliteErrors;
+ (void)initialize;
+ (id)writeQueue;
