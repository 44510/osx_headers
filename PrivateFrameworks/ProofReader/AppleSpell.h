...
- (BOOL)_addLanguageModelCompletionsForPartialWordRange:(struct _NSRange)arg1 language:(id)arg2 connection:(struct _PR_DB_IO *)arg3 sender:(id)arg4 encoding:(unsigned int)arg5 tagger:(id)arg6 taggerIndex:(unsigned long long)arg7 appIdentifier:(id)arg8 candidates:(id)arg9 scoreDictionary:(id)arg10;
...
- (unsigned long long)_contextLengthForRange:(struct _NSRange)arg1 tagger:(id)arg2 taggerIndex:(unsigned long long)arg3 languageModel:(void *)arg4 maxContextLength:(unsigned long long)arg5 context:(unsigned int *)arg6;
