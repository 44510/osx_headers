...
@class NSAccessibilityRemoteUIElement, NSColor, NSLayoutConstraint, NSMutableArray, NSProxy<NSXPCProxyCreating>, NSResponder, NSString, NSVB_ViewServiceBehaviorProxy, NSViewBridge, NSViewService, NSXPCConnection, NSXPCInterface;
...
- (void)bootstrapWithSize:(struct CGSize)arg1 serviceSubclassName:(id)arg2 windowRightsToken:(id)arg3 windowRightsRecipient:(unsigned int)arg4 rendezvousWindowIdentifier:(id)arg5 trustServiceKeyEvents:(BOOL)arg6 withReply:(CDUnknownBlockType)arg7;
- (id)bootstrapWithSize:(struct CGSize)arg1 serviceSubclassName:(id)arg2 rendezvousWindowIdentifier:(id)arg3 replyData:(CDStruct_6343ed5c *)arg4;
@property(readonly) struct CGSize sizeHint;
- (void)didSetView;
- (void)ensureLayoutConstraints;
- (void)prepareWindow:(id)arg1 willEnsureBorderViewLayer:(BOOL)arg2;
...
- (void)deactivateTSM:(const char *)arg1;
- (void)activateTSM:(const char *)arg1;
- (void)lostKeyFocus;
- (BOOL)stoleKeyFocus;
