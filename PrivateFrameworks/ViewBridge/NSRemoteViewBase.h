...
- (void)_addChildWindow:(id)arg1 windowBase:(unsigned char)arg2 ordered:(long long)arg3 content:(struct CGRect)arg4;
...
- (void)_advanceToConfigPhase:(id)arg1 awaitingWindowRights:(CDUnknownBlockType)arg2 completion:(CDUnknownBlockType)arg3;
...
- (void)ensureServiceMarshalConnection:(CDUnknownBlockType)arg1;
- (void)configureResumeAndRetainServiceMarshalConnection:(id)arg1;
