...
@class NSArray, NSData, NSNumber, NSObject<NSSecureCoding>, NSSecureColor, NSSet, NSString;
...
- (void)bootstrapWithSize:(struct CGSize)arg1 serviceSubclassName:(NSString *)arg2 windowRightsToken:(NSString *)arg3 windowRightsRecipient:(unsigned int)arg4 rendezvousWindowIdentifier:(NSString *)arg5 trustServiceKeyEvents:(BOOL)arg6 withReply:(void (^)(NSString *, struct))arg7;
@end
