...
+ (id)removeKeywords:(id)arg1 fromVersions:(id)arg2;
+ (id)removeKeywords:(id)arg1 fromVersion:(id)arg2;
+ (id)addKeywords:(id)arg1 toVersion:(id)arg2;
+ (void)replaceKeywordId:(id)arg1 withKeywordId:(id)arg2 forDatabase:(id)arg3;
