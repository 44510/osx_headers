...
@class LiProgress, LiRequest, NSError;
...
@interface LiReply : LiMessage
{
    ...
    CDStruct_c802c68a _stats;
}

@property(nonatomic) CDStruct_c802c68a stats; // @synthesize stats=_stats;
@property(retain, nonatomic) LiProgress *progress; // @synthesize progress=_progress;
@property(retain, nonatomic) NSError *error; // @synthesize error=_error;
@property(retain, nonatomic) LiRequest *request; // @synthesize request=_request;
