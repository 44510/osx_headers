...
+ (id)modelName;
+ (Class)modelClass;
@property(readonly, nonatomic) LiKeyPath *faceIdsKeyPath; // @synthesize faceIdsKeyPath=_faceIdsKeyPath;
...
@property(readonly, nonatomic) LiKeyPath *countKeyPath; // @synthesize countKeyPath=_countKeyPath;
