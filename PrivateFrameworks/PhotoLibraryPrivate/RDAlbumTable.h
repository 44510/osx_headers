...
@interface RDAlbumTable : RDTable
{
    ...
    LiKeyPath *_selectedVersionIdsKeyPath;
    ...
    LiKeyPath *_printProjectAspectRatioKeyPath;
...
@property(readonly, nonatomic) LiKeyPath *printProjectAspectRatioKeyPath; // @synthesize printProjectAspectRatioKeyPath=_printProjectAspectRatioKeyPath;
...
@property(readonly, nonatomic) LiKeyPath *selectedVersionIdsKeyPath; // @synthesize selectedVersionIdsKeyPath=_selectedVersionIdsKeyPath;
