...
@class MMPhoneNumberFormatter, NSBox, NSButton, NSImageView, NSLayoutConstraint, NSPopUpButton, NSString, NSTextField, NSWindow;
...
@interface MMKeychainOptionsController : NSViewController <MMCSCSetupControllerDelegate, MMAuthenticatingPasswordSheetDelegate>
{
    ...
    NSLayoutConstraint *_phoneNumberConstraint;
...
- (void)setSMSTargetEnabled:(BOOL)arg1;
