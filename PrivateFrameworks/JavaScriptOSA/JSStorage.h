...
- (void).cxx_destruct;
- (void)setActiveProcForAllContexts:(CDUnknownFunctionPointerType)arg1 withRefCon:(void *)arg2;
- (void)setSendProcForAllContexts:(CDUnknownFunctionPointerType)arg1 withRefCon:(void *)arg2;
