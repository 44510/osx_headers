...
struct MeshMesh {
    ...
    struct shared_ptr<ggl::VertexData> _field6;
    struct shared_ptr<ggl::IndexData> _field7;
    struct shared_ptr<ggl::PolygonBase::MeshVertexData> _field8;
};
...
struct MeshVendor<ggl::PolygonBase::MeshMesh>;
...
struct TexturedDrawable {
    struct unique_ptr<ggl::MeshVendor<ggl::PolygonBase::MeshMesh>, std::__1::default_delete<ggl::MeshVendor<ggl::PolygonBase::MeshMesh>>> _field1;
...
struct shared_ptr<ggl::PolygonBase::MeshVertexData> {
    struct MeshVertexData *_field1;
    struct __shared_weak_count *_field2;
};
...
struct unique_ptr<ggl::MeshVendor<ggl::PolygonBase::MeshMesh>, std::__1::default_delete<ggl::MeshVendor<ggl::PolygonBase::MeshMesh>>> {
    struct __compressed_pair<ggl::MeshVendor<ggl::PolygonBase::MeshMesh>*, std::__1::default_delete<ggl::MeshVendor<ggl::PolygonBase::MeshMesh>>> {
        struct MeshVendor<ggl::PolygonBase::MeshMesh> *_field1;
    } _field1;
};
