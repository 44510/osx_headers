...
@interface VKRealisticRoadGroup : NSObject
{
    ...
    struct fast_shared_ptr<ggl::PolygonBase::MeshMesh> _topMesh;
    ...
    struct fast_shared_ptr<ggl::PolygonBase::MeshMesh> _sidewalkShadowMesh;
...
@property(readonly, nonatomic) struct MeshMesh *casingSidewalkShadowMesh;
@property(readonly, nonatomic) struct MeshMesh *casingTopMesh;
