...
@class AVConference, NSError, NSMutableArray;
...
@property(retain, nonatomic) NSError *conferenceDidStopError; // @synthesize conferenceDidStopError=_conferenceDidStopError;
