...
- (void)_sendFriendshipOfferWithAutoSwitchMeDeviceForHandles:(id)arg1 groupId:(id)arg2 callerId:(id)arg3 endDate:(id)arg4 completion:(CDUnknownBlockType)arg5;
- (void)_sendFriendshipOfferWithoutTryingToSwitchMeDeviceForHandles:(id)arg1 groupId:(id)arg2 callerId:(id)arg3 endDate:(id)arg4 completion:(CDUnknownBlockType)arg5;
