...
@class BU_ArrowedFlatControl, BU_DateFlatControl, BU_FlatControl, BU_TMControl, BU_TMFloatParameterController, BU_TMTimeline, BU_TMToolbarPushButton, BU_TTimelineOverlay, CABackdropLayer, CALayer, CAMediaTimingFunction, NSMutableArray;
...
@interface BU_TBackupView : NSView
{
    ...
    unsigned long long fStackSwapLevel;
    ...
    BU_FlatControl *fCancelButton;
    BU_FlatControl *fRestoreButton;
    BU_DateFlatControl *fDateText;
    BU_ArrowedFlatControl *fPreviousButton;
    BU_ArrowedFlatControl *fNextButton;
