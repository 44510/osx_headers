...
+ (id)_gkConstraintsForViews:(id)arg1 contiguouslyLaidOutVertically:(BOOL)arg2 overlap:(double)arg3 withinView:(id)arg4 insets:(CDStruct_3c058996)arg5 applyOrthogonalConstraints:(BOOL)arg6;
+ (id)_gkConstraintsForViews:(id)arg1 contiguouslyLaidOutVertically:(BOOL)arg2 overlap:(double)arg3 withinView:(id)arg4 insets:(CDStruct_3c058996)arg5;
+ (id)_gkConstraintsForViews:(id)arg1 alignedByAttribute:(long long)arg2;
+ (id)_gkConstraintsForView:(id)arg1 withinView:(id)arg2 insets:(CDStruct_3c058996)arg3;
