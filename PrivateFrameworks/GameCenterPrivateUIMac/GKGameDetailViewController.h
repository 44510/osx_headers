...
@class GKAchievementsDataSource, GKChallengesDataSource, GKCollectionViewAggregateDataSource, GKCollectionViewDataSource, GKFriendPlayersDataSource, GKGameDetailWrapperController, GKGameRecentPlayersDataSource, GKGameRecommendationInternal, GKGameRecord, GKLeaderboardHeaderView, GKLeaderboardScoresDataSource, GKSegmentedSectionDataSource, GKSupplementaryViewMetrics, NSCollectionReusableView, NSString, NSViewController;
...
- (void)challengeSuggestViewControllerDidFinish:(id)arg1;
