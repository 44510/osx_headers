...
@interface NSUICollectionView : NSScrollView
{
    ...
    CDStruct_3c058996 _scrollIndicatorInsets;
...
@property(nonatomic) CDStruct_3c058996 scrollIndicatorInsets; // @synthesize scrollIndicatorInsets=_scrollIndicatorInsets;
...
- (id)_currentUpdate;
- (void)scrollRect:(struct CGRect)arg1 toScrollPosition:(unsigned long long)arg2 withInsets:(CDStruct_3c058996)arg3 animated:(BOOL)arg4;
- (void)scrollToItemAtIndexPath:(id)arg1 atScrollPosition:(unsigned long long)arg2 animated:(BOOL)arg3;
- (void)_scrollRect:(struct CGRect)arg1 toScrollPosition:(unsigned long long)arg2 withInsets:(CDStruct_3c058996)arg3 animated:(BOOL)arg4;
...
- (CDStruct_3c058996)contentInset;
