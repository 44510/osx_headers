...
@class BatteryGraphManager, NSBox, NSButton, NSDictionary, NSImage, NSMatrix, NSMenu, NSMenuItem, NSMutableArray, NSMutableDictionary, NSNumberFormatter, NSObject<OS_dispatch_queue>, NSObject<OS_sysmon_request>, NSObject<OS_sysmon_row>, NSOutlineView, NSPanel, NSPopUpButton, NSSegmentedControl, NSString, NSTabView, NSTableColumn, NSTextField, NSTimer, NSWindow, NetStatManager, SMCPUInfo, SMCPUMonitor, SMDiskInfo, SMNetworkInfo, TotalPowerGraphManager;
...
@property(retain) NSMutableArray *placeHolderProcesses; // @synthesize placeHolderProcesses=_placeHolderProcesses;
@property(retain) NSMutableArray *allProcesses; // @synthesize allProcesses=_allProcesses;
@property(retain) NSMutableDictionary *processes; // @synthesize processes=_processes;
- (void).cxx_destruct;
- (void)dealloc;
