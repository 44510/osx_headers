...
@class NSArray, NSBrowser, NSButton, NSButtonCell, NSComboBox, NSMutableArray, NSMutableDictionary, NSNetService, NSNetServiceBrowser, NSPopUpButton, NSString, NSTextField, NSWindow;
