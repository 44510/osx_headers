...
+ (BOOL)automaticallyNotifiesObserversOfMessageNumber;
+ (BOOL)automaticallyNotifiesObserversOfIsDeleted;
+ (BOOL)automaticallyNotifiesObserversOfIsPrimary;
+ (BOOL)automaticallyNotifiesObserversOfSignerNames;
+ (BOOL)automaticallyNotifiesObserversOfSigners;
+ (BOOL)automaticallyNotifiesObserversOfIsSigned;
+ (BOOL)automaticallyNotifiesObserversOfIsEncrypted;
...
- (void)cancelLoad;
- (void)asyncLoad:(CDUnknownBlockType)arg1;
- (void)invalidate;
- (id)description;
