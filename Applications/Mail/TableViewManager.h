...
@class MFMessageThread, MailTableView, MessageListContainerView, MessageMall, MessageViewer, NSArray, NSCache, NSDictionary, NSFont, NSImageView, NSMapTable, NSMutableArray, NSMutableAttributedString, NSMutableDictionary, NSMutableSet, NSSet, NSString, NSTableColumn, NSTableHeaderView, TableViewScrollState;
...
@property(nonatomic) BOOL initiallyPinToBottom; // @synthesize initiallyPinToBottom=_initiallyPinToBottom;
