...
+ (id)viewerForMessage:(id)arg1 hiddenCopies:(id)arg2 showRelatedMessages:(BOOL)arg3 showAllHeaders:(BOOL)arg4 expandedSelectedMailboxes:(id)arg5;
...
- (id)initForViewingMessage:(id)arg1 hiddenCopies:(id)arg2 showRelatedMessages:(BOOL)arg3 showAllHeaders:(BOOL)arg4 expandedSelectedMailboxes:(id)arg5 withAttributes:(id)arg6;
