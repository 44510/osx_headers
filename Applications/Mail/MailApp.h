...
#import "IMAPUserAgent.h"
#import "MCActivityTarget.h"
#import "MCUserAgent.h"
...
@class ActivityViewer, DeliveryQueue, DockCountController, DocumentEditor, DynamicErrorWindowController, FlagsMenuItemView, MailboxesController, NSMenu, NSMutableArray, NSMutableData, NSMutableSet, NSOutputStream, NSString, NSTimer, NSWindow, SingleMessageViewer;

@interface MailApp : NSApplication <IMAPUserAgent, MCUserAgent, MFUserAgent, NSStreamDelegate, MCActivityTarget, MVTerminationHandler, NSApplicationDelegate, NSMenuDelegate>
{
...
@property(nonatomic) unsigned long long numberOfAccountsEmptyingTrash; // @synthesize numberOfAccountsEmptyingTrash=_numberOfAccountsEmptyingTrash;
