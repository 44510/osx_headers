...
@class CALayer, FavoritesBarView, MailBarContainerButton, MessageViewer, NSArray, NSButton, NSLayoutConstraint, NSStackView, NSString, _SidebarButton;
...
@property(nonatomic) __weak CALayer *topDividerLayer; // @synthesize topDividerLayer=_topDividerLayer;
