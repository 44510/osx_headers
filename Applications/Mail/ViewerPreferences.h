...
@interface ViewerPreferences : NSPreferencesModule <NSTableViewDataSource>
{
    ...
    NSButton *_useShortNamesSwitch;
    NSPopUpButton *_shortNameFormatPopup;
    NSButton *_preferNicknamesSwitch;
...
@property(nonatomic) __weak NSButton *preferNicknamesSwitch; // @synthesize preferNicknamesSwitch=_preferNicknamesSwitch;
@property(nonatomic) __weak NSPopUpButton *shortNameFormatPopup; // @synthesize shortNameFormatPopup=_shortNameFormatPopup;
@property(nonatomic) __weak NSButton *useShortNamesSwitch; // @synthesize useShortNamesSwitch=_useShortNamesSwitch;
