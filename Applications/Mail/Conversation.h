...
@interface Conversation : NSObject <NSCopying>
{
    ...
    CDUnknownBlockType _conversationMembersLoadedCompletionHandler;
}
...
@property(copy, nonatomic) CDUnknownBlockType conversationMembersLoadedCompletionHandler; // @synthesize conversationMembersLoadedCompletionHandler=_conversationMembersLoadedCompletionHandler;
