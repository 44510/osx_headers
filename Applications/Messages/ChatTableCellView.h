...
@class ChatBuddyPicturesView, InstantMessage, MaskedView, NSArray, NSButton, NSLayoutConstraint, NSTextField, NSTimer, NSTrackingArea, NSView, SOChatDisplayController, SOStaticImageView, SOTypingIndicatorView;
...
+ (id)backdropBlack;
+ (id)_selectedBubbleColor;
+ (id)_bubbleColor;
+ (id)_selectedTextShadow;
+ (id)_textShadow;
...
- (void)close:(id)arg1;
@property(readonly) long long monogramBackgroundStyle; // @dynamic monogramBackgroundStyle;
