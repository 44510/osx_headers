...
#import "SOProgressBarViewControllerSendingTextDelegate.h"
...
@interface ChatViewController : NSViewController <SOInputLineViewControllerDelegate, IMChatSendProgressDelegate, SOProgressBarViewControllerSendingTextDelegate>
{
...
- (void)progressBarViewControllerDidDisplaySendingText:(id)arg1 animate:(BOOL)arg2;
- (void)progressBarViewControllerWillDisplaySendingText:(id)arg1 animate:(BOOL)arg2;
...
- (void)viewDidLoad;
- (void)_beginNewChat;
- (void)_switchToIMHandle:(id)arg1;
