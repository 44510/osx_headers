...
#import "OrderedSetControllerDelegate.h"
...
@interface UnifiedChatListViewController : NSViewController <NSPopoverDelegate, NSTableViewDelegate, NSTableViewDataSource, OrderedSetControllerDelegate>
{
