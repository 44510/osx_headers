...
#import "VCRenderDelegateProtocol.h"

@class CIContext, FrameReader, FrameResizer, FramerateTracker, NSArray, NSMutableDictionary, NSObject<OS_dispatch_queue>, NSOpenGLContext, NSRecursiveLock, NSString, QCComposition, QCPatchController, QCRenderer, Texture;
