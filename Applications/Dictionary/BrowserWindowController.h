...
#import "DictionaryHistoryDelegate.h"

@class DictionaryController, DictionaryHistory, DictionaryScopeBar, DictionarySearchField, NSDictionary, NSMutableArray, NSObjectController, NSPageController, NSPrintInfo, NSProgressIndicator, NSSegmentedControl, NSString, NSTextField, NSWindow;
