...
@class FBBackgroundView, FBCollectionViewController, FBDuplicateResolutionWindowController, FBFontViewController, FBGroup, FBLanguagePicker, FBMultiPreviewController, FBPrintController, FBProgressWindowController, FBSearchController, FBSmartCollection, NSArray, NSBox, NSButton, NSDrawer, NSImage, NSMenu, NSMutableArray, NSNumberFormatter, NSPredicateEditor, NSPrintOperation, NSResponder, NSSegmentedControl, NSSpeechSynthesizer, NSSplitView, NSString, NSTextField, NSTimer, NSUndoManager, NSView, NSWindow;

@interface FBUIController : NSWindowController <NSSplitViewDelegate, NSToolbarDelegate, NSAnimationDelegate>
{
