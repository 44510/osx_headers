...
@class CalDateRange, CalUIDayCanvasController, CalUIDayLayerController, CalUIDayLayerGridlineView, NSArray, NSDate, NSLayoutConstraint, NSMutableDictionary, NSString, NSView;
...
- (BOOL)_isOccurenceVisibleOnCanvas:(id)arg1;
