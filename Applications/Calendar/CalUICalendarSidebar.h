...
#import "CalUICalendarListDataSourceDelegateEK.h"
#import "CalUIMiniMonthViewDelegate.h"
#import "NSSplitViewDelegate.h"

@class CALMainController, CalUICalendarListDataSourceEK, CalUICalendarListViewController, CalUICalendarSidebarShadowSplitter, NSMutableArray, NSScrollView, NSSplitView, NSString, NSView, NSVisualEffectView;
...
@interface CalUICalendarSidebar : NSViewController <CalUICalendarListDataSourceDelegateEK, NSSplitViewDelegate, CalUIMiniMonthViewDelegate>
{
    ...
    NSView *_calendarListScrollViewContainerView;
    CalUICalendarSidebarShadowSplitter *_shadowSplitterView;
...
@property(retain) NSVisualEffectView *backdropView; // @synthesize backdropView=_backdropView;
@property(retain) CalUICalendarSidebarShadowSplitter *shadowSplitterView; // @synthesize shadowSplitterView=_shadowSplitterView;
@property(retain) NSView *calendarListScrollViewContainerView; // @synthesize calendarListScrollViewContainerView=_calendarListScrollViewContainerView;
...
- (void).cxx_destruct;
- (double)alphaForSplitViewDividerShadow;
...
- (void)splitterPositionDidChange;
