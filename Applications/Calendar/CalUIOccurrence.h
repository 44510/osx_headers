...
#import "CalUIInspectableOccurrence.h"
...
@property(nonatomic) id <CalUIOccurrenceDelegate> delegate; // @synthesize delegate=_delegate;
@property(nonatomic) id <CalUIOccurrenceContainer> container; // @synthesize container=_container;
- (void).cxx_destruct;
- (long long)compareGeometryForCanvasView:(id)arg1;
- (BOOL)isSelected;
