...
#import "CalUIFaceClient.h"
#import "NSTableViewDataSource.h"
#import "NSTableViewDelegate.h"

@class CALMainController, CalMessageTableView, CalUIFaceCache, NSArray, NSMutableSet, NSString, NSTableColumn;

@interface CalMessageTableController : NSObject <NSTableViewDelegate, NSTableViewDataSource, CalUIFaceClient>
{
...
@property(retain) CalUIFaceCache *faceCache; // @synthesize faceCache=_faceCache;
...
- (void)_handleMessagesReplied:(id)arg1;
- (void)handleMessagesReplied:(id)arg1;
- (void)handleMessageReplied:(id)arg1;
