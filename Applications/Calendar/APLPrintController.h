...
#import "CalendarOutlineViewDataSource.h"

@class APLImageView, APLLayout, APLModel, APLPresetsController, APLRangeController, APLView, CALMainController, CALNumericFormatter, EKEventStore, NSArray, NSBox, NSButton, NSDictionary, NSMenu, NSMutableArray, NSMutableDictionary, NSPopUpButton, NSPrintInfo, NSSlider, NSString, NSTextField, NSView, NSWindow;
