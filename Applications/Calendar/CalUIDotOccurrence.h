...
@class CalUIFontSmoothedTextField, CalUILayerBackedView, NSDictionary, NSFont, NSLayoutConstraint, NSView;
...
- (struct CGPoint)_offsetForDragImage:(id)arg1;
...
@property(nonatomic) id <CalUIDotOccurrenceDelegate> delegate;
