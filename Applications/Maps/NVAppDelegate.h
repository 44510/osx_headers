...
@interface NVAppDelegate : NSObject <MapsDebugViewControllerDelegate, MapsPushDaemonProxyObserver, NSApplicationDelegate, NSMenuDelegate, NSUserNotificationCenterDelegate>
{
    NSMenuItem *alwayShowLabelsMenuItem;
    NSMenuItem *hybridLegacy;
    NSMenuItem *satelliteLegacy;
    ...
    NSMenuItem *_altMapTypeMenuItem;
}

@property BOOL usesMiles; // @synthesize usesMiles=_usesMiles;
@property __weak NSMenuItem *altMapTypeMenuItem; // @synthesize altMapTypeMenuItem=_altMapTypeMenuItem;
