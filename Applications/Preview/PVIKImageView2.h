...
#import "PVImageViewProtocol.h"
#import "PVLoupeMagnifiableView.h"

@class CALayer, NSArray, NSColor, NSCursor, NSMutableArray, NSObject, NSString, NSTrackingArea, PVFloatingStringPanel, PVIVSelection, PVImageElement, Profile;
