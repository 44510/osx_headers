...
@class AVCaptureScreenInput, AVPlayer, CALayer, MGCaptureAudioPreviewOutput, MGCaptureCompressionPreset, MGCaptureDeviceSelectionController, MGScreenRecordingDocumentViewController, MGScreenSelector, NSArray, NSObject<OS_dispatch_semaphore>, NSScreen, NSStatusItem, NSString, NSURL, _NSBorderlessLayerTreeProjectionWindow;
...
@interface MGScreenRecordingDocument : MGRecordingDocument <MGInspectionAttributeContainer, MGScreenSelectorDelegate, NSMenuDelegate>
{
    ...
    _NSBorderlessLayerTreeProjectionWindow *_fullscreenWindow;
