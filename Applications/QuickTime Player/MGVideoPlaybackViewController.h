...
#import "AVSharingServicesDelegate.h"
#import "MGVisualContentContainer.h"

@class MGBackgroundColorView, MGEditViewController, MGPlayerView, NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_source>, NSString, NSWindowController;
